...
export function MethodView() {
  ...
  return <section id="workspace" className="secondary prose"><p className="eyebrow">METHODOLOGY · {PRODUCT_VERSION}</p><h2>What was recorded, and what it means.</h2>
    ...
    <p><strong>SpaPhish v5 [Spanish Input Questions]</strong> replays those same 499 emails with Spanish signal questions under policy-v1-es-exp. A signal counts as indicated at 0.70. The English-question SpaPhish tab stays on policy-v1, where a signal counts as indicated at 0.80. Each SpaPhish recording is reported on its own.</p>
    <h3>This website</h3>
